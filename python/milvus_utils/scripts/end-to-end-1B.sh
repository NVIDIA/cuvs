...
export COLLECTION_NAME=falcon_1024_960M
export DESC_FILE=falcon_desc.txt
export BASE_FILE=/raid/data/falcon_1024_960M_dataset/base_falcon_1024_960M.fbin
...
export RESULTS_DIR=result_960M_019_clustering_2

cd ../../VectorDBBench/vectordbbench
source venv/bin/activate
python3 run_vectordbbench.py --case=milvusaisaq --config_file=$MILVUS_CONFIG_FILE --out results_960M --search_list=10,20,30,40,50,60,70,75,80,85,90,95,100
python3 ../../Benchmark_Instructions/json_files_to_csv.py 'vectordb_bench/results/Milvus/result_20260308*.json' results_960M/${RESULTS_DIR}.csv
mkdir vectordb_bench/results/Milvus/$RESULTS_DIR
mv vectordb_bench/results/Milvus/result_20260308*.json vectordb_bench/results/Milvus/$RESULTS_DIR
