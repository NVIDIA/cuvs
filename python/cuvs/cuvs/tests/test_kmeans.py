...
@pytest.mark.parametrize("device_buffer_batch_size", [0, 100, 239, 500])
@pytest.mark.parametrize("dtype", [np.float64])
@pytest.mark.parametrize("weighted", [False, True])
def test_fit_host_matches_fit_device(
    n_rows, n_cols, n_clusters, device_buffer_batch_size, dtype, weighted
):
    """
    ...
    params_host = KMeansParams(
        ...
        max_iter=20,
        tol=1e-10,
        device_buffer_batch_size=device_buffer_batch_size,
    )
