...
#[repr(u32)]
#[doc = " @brief Generic dataset layout kind for C API dataset handles."]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
unsafe extern "C" {
    #[must_use]
    #[doc = " @brief Create a non-owning padded dataset view from a host- or device-resident tensor.\n\n Memory residency is inferred from the tensor."]
...
unsafe extern "C" {
    #[must_use]
    #[doc = " @brief Create a non-owning standard dataset view from a host- or device-resident tensor.\n\n Memory residency is inferred from the tensor."]
...
unsafe extern "C" {
    #[must_use]
    #[doc = " @brief Destroy a dataset handle created by a `cuvsDatasetMake*` function."]
    pub fn cuvsDatasetDestroy(dataset: cuvsDataset_t) -> cuvsError_t;
}
unsafe extern "C" {
    #[must_use]
    #[doc = " @brief Get the memory residency of a dataset handle."]
...
unsafe extern "C" {
    #[must_use]
    #[doc = " @brief Get the layout of a dataset handle."]
...
unsafe extern "C" {
    #[must_use]
    #[doc = " @brief Get whether a dataset handle owns its backing storage."]
    pub fn cuvsDatasetGetIsOwning(dataset: cuvsDataset_t, is_owning: *mut bool) -> cuvsError_t;
}
unsafe extern "C" {
    #[must_use]
    #[doc = " @brief Get the element dtype of a dataset handle."]
...
#[repr(u32)]
#[doc = " Algorithm used to merge physical CAGRA indices."]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum cuvsCagraMergeAlgo {
    CUVS_CAGRA_MERGE_AUTO = 0,
    CUVS_CAGRA_MERGE_FASTENER = 1,
    CUVS_CAGRA_MERGE_REBUILD = 2,
}
#[doc = " Parameters controlling how physical CAGRA indices are merged."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cuvsCagraMergeParams {
    pub algo: cuvsCagraMergeAlgo,
    pub levels: u32,
    pub root_fanout: u32,
    pub lower_fanout: u32,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of cuvsCagraMergeParams"][::std::mem::size_of::<cuvsCagraMergeParams>() - 40usize];
    ["Alignment of cuvsCagraMergeParams"][::std::mem::align_of::<cuvsCagraMergeParams>() - 8usize];
    ["Offset of field: cuvsCagraMergeParams::algo"]
        [::std::mem::offset_of!(cuvsCagraMergeParams, algo) - 0usize];
    ["Offset of field: cuvsCagraMergeParams::levels"]
        [::std::mem::offset_of!(cuvsCagraMergeParams, levels) - 4usize];
    ["Offset of field: cuvsCagraMergeParams::root_fanout"]
        [::std::mem::offset_of!(cuvsCagraMergeParams, root_fanout) - 8usize];
    ["Offset of field: cuvsCagraMergeParams::lower_fanout"]
        [::std::mem::offset_of!(cuvsCagraMergeParams, lower_fanout) - 12usize];
    ["Offset of field: cuvsCagraMergeParams::leader_fraction"]
        [::std::mem::offset_of!(cuvsCagraMergeParams, leader_fraction) - 16usize];
    ["Offset of field: cuvsCagraMergeParams::max_leaders"]
        [::std::mem::offset_of!(cuvsCagraMergeParams, max_leaders) - 24usize];
    ["Offset of field: cuvsCagraMergeParams::leaf_size"]
        [::std::mem::offset_of!(cuvsCagraMergeParams, leaf_size) - 28usize];
    ["Offset of field: cuvsCagraMergeParams::leaf_degree"]
        [::std::mem::offset_of!(cuvsCagraMergeParams, leaf_degree) - 32usize];
};
pub type cuvsCagraMergeParams_t = *mut cuvsCagraMergeParams;
unsafe extern "C" {
    #[must_use]
...
unsafe extern "C" {
    #[must_use]
    #[doc = " Allocate CAGRA merge params and populate them with AUTO defaults."]
    pub fn cuvsCagraMergeParamsCreate(params: *mut cuvsCagraMergeParams_t) -> cuvsError_t;
}
unsafe extern "C" {
    #[must_use]
    #[doc = " De-allocate CAGRA merge params."]
    pub fn cuvsCagraMergeParamsDestroy(params: cuvsCagraMergeParams_t) -> cuvsError_t;
}
unsafe extern "C" {
    #[must_use]
