...
pub struct cuvsHnswIndexParams {
    ...
    pub metric: cuvsDistanceType,
    #[doc = " Optional: specify ACE parameters for partitioned or disk-backed GPU graph building.\n Set to nullptr to build with HNSW parameters and let cuVS choose CAGRA graph\n build settings internally."]
