...
// Unified non-BlockSort LUT kernel. The WithEx-axis-specific body (IP2
// precompute + per-vector distance write for WithEx=true, LUT-only distance
// write for WithEx=false) lives in the lut_emit_distances JIT-LTO fragment, so
