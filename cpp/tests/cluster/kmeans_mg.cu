...
class KmeansSNMGTest : public ::testing::TestWithParam<KmeansSNMGInputs<T>> {
 protected:
  ...
  void runTest()
  {
    ...
    snmg_params.device_buffer_batch_size = testparams_.device_buffer_batch_size;
    snmg_params.device_buffer_prefetch   = testparams_.device_buffer_prefetch;
...
const std::vector<KmeansSNMGInputs<float>> snmg_inputsf = {
  // n_row, n_col, n_clusters, tol, weight_mode, device_buffer_batch_size, n_init[, init]
